...
?>
<script src="../js/funciones_artistas.js"></script>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Editar Artistas</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">
            <input type="text" hidden="" id="id_artista" name="">
            <label>Nombre</label>
            <input type="text" name="" id="artistaU" class="form-control input-sm" required>
            <label>Genero</label>
